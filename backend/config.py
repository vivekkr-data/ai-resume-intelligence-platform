...
class Settings:
    app_name: str = os.getenv("APP_NAME", "AI Resume Intelligence Platform")
    app_version: str = os.getenv("APP_VERSION", "2.0.0")
    environment: str = os.getenv("APP_ENV", "development")
    database_url: str = normalize_database_url(
        os.getenv("DATABASE_URL", f"sqlite:///{BASE_DIR / 'resume_analyzer.db'}")
    )
    ...
    store_pii: bool = _as_bool("STORE_PII", False)
    admin_api_key: str = os.getenv("ADMIN_API_KEY", "")
    admin_dashboard_pin: str = os.getenv("ADMIN_DASHBOARD_PIN", "")
    enable_admin_dashboard: bool = _as_bool("ENABLE_ADMIN_DASHBOARD", True)
